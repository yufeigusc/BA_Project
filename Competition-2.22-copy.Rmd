...
lm_model <- lm(sales_1_month ~ .-went_on_backorder-sku-potential_issue-risk_flag-inventory_turnover_ratio1-inventory_compliance-neg_inv, data = train)
summary(lm_model)
# Predict the response variable using linear regression
train$predicted_sales <- predict(lm_model, newdata = train)
...
str(PredTest2)
write.csv(PredTest2, "Test_4.csv", row.names = FALSE)
```
