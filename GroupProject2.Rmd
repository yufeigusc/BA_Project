...
temp_data7$risk_flag = temp_data7$risk_flag - train_before_factor$deck_risk + train_before_factor$rev_stop
...
```{r}
crossv(went_on_backorder ~ . - sku+lead_time/in_transit_qty-perf_12_month_avg-perf_6_month_avg-lead_time-sales_1_month-min_bank-forecast_6_month-forecast_9_month, temp_data7)
```
- multiplication on local_bo_qty and pieces_past_due help a little
```{r}
temp_data8 = temp_data7
temp_data8$overdue_factor = temp_data7$local_bo_qty*temp_data7$pieces_past_due
```


```{r}
crossv(went_on_backorder ~ . - sku+lead_time/in_transit_qty-perf_12_month_avg-perf_6_month_avg-lead_time-sales_1_month-min_bank-forecast_6_month-forecast_9_month, temp_data8)
```
- ration on peices_past_due and local_bo_qty does not help much
```{r}
