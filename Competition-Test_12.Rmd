...
```{r}
registerDoParallel(cores = round(detectCores(logical = FALSE)*3/4) )
```
...
ntree:  900  nodesize:  12  bestMtry:  9  ROC:  0.953086 
ntree:  1000  nodesize:  12  bestMtry:  9  ROC:  0.953156
ntree:  1100  nodesize:  12  bestMtry:  9  ROC:  0.9532469 

ntree:  900  nodesize:  6  bestMtry:  8  ROC:  0.9545864


```{r}
ntree_list = c(900, 1000, 1100)
cur_nodesize = 6
...
for (cur_ntree in ntree_list) {
  ...
  cat("ntree: ", cur_ntree, " nodesize: ", cur_ntree, " bestMtry: ", bestMtry, " ROC: ", bestROC,  "\n")
}
```
