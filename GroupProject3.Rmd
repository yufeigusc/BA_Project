...
- Check means of forecast

```{r}
average_forecast_3 <- mean(train$forecast_3_month, na.rm = TRUE)
average_forecast_6 <- mean(train$forecast_6_month, na.rm = TRUE)
average_forecast_9 <- mean(train$forecast_9_month, na.rm = TRUE)
str(average_forecast_3)
str(average_forecast_6)
str(average_forecast_9)

average_sale_1 <- mean(train$sales_1_month, na.rm = TRUE)
average_sale_3 <- mean(train$sales_3_month, na.rm = TRUE)
average_sale_6 <- mean(train$sales_6_month, na.rm = TRUE)
average_sale_9 <- mean(train$sales_9_month, na.rm = TRUE)
str(average_sale_1)
str(average_sale_3)
str(average_sale_6)
str(average_sale_9)
...
columns_of_interest <- c("forecast_1to3", "forecast_3to6", "forecast_6to9", "sales_0to1", "sales_1to3", "sales_3to6", "sales_6to9")
temp_data_subset <- temp_data1[, columns_of_interest]

# Calculate the correlation matrix
correlation_matrix <- cor(temp_data_subset)
...
_ rebuild model with new columns
```{r}
set.seed(123)
